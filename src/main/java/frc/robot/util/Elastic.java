...
public final class Elastic {
  ...
  /**
   * Represents the possible levels of notifications for the Elastic
   * dashboard. These levels are used to indicate the severity or type
   * of notification.
   */
   ...
   * serialized as a JSON string before being published.
   *
   * @param notification the {@link Notification} object containing
  ...
  /**
   * Selects the tab of the dashboard with the given name. If no tab
   * matches the name, this will have no effect on the widgets or tabs
   * in view.
   *
   * <p>
   * If the given name is a number, Elastic will select the tab whose
   * index equals the number provided.
   *
  ...
  /**
   * Selects the tab of the dashboard at the given index. If this index
   * is greater than or equal to the number of tabs, this will have no
   * effect.
   *
  ...
  /**
   * Represents an notification object to be sent to the Elastic
   * dashboard. This object holds properties such as level, title,
   * description, display time, and dimensions to control how the
  ...
  public static class Notification {
    ...
    /**
     * Creates a new Notification with all default parameters. This
     * constructor is intended to be used with the chainable decorator
     * methods
     *
     * <p>
     ...
     * @param displayTimeMillis the time in milliseconds for which the
     *        notification is displayed
     * @param width the width of the notification display area
     * @param height the height of the notification display area, inferred
     *        if below zero
     */
    ...
    /**
     * Creates a new Notification with default display time and
     * dimensions.
     *
    ...
    /**
     * Creates a new Notification with a specified display time and
     * default dimensions.
     *
     * @param level the level of the notification
     * @param title the title text of the notification
    ...
    /**
     * Creates a new Notification with specified dimensions and default
     * display time. If the height is below zero, it is automatically
     * inferred based on screen size.
     *
     * @param level the level of the notification
     * @param title the title text of the notification
     * @param description the descriptive text of the notification
     ...
     *
     * @param seconds the number of seconds to display the notification
     *        for
     */
     ...
     *
     * @return the number of milliseconds the notification is displayed
     *         for
     */
    ...
    /**
     * Modifies the notification's level and returns itself to allow for
     * method chaining
     *
     * @param level the level to set the notification to
    ...
    /**
     * Modifies the notification's title and returns itself to allow for
     * method chaining
     *
     * @param title the title to set the notification to
     * @return the current notification
    ...
    /**
     * Modifies the notification's description and returns itself to allow
     * for method chaining
     *
     * @param description the description to set the notification to
     * @return the current notification
    ...
    /**
     * Modifies the notification's display time and returns itself to
    ...
    /**
     * Modifies the notification's width and returns itself to allow for
     * method chaining
     *
     * @param width the width to set the notification to
     * @return the current notification
    ...
    /**
     * Modifies the notification's height and returns itself to allow for
     * method chaining
     *
     * @param height the height to set the notification to
     * @return the current notification
     ...
     *
     * <p>
     * This will set the height to -1 to have it automatically determined
     * by the dashboard
     *
     * @return the current notification
     */
  ...
  public static void recordWidgetType(String key, BuiltInWidgets widgetType) {
    Logger.recordOutput(key + "/.type", widgetType.getWidgetName());
  }

  public static void recordWidgetType(String key, String widgetType) {
    Logger.recordOutput(key + "/.type", widgetType);
  }

  public static void recordWidgetType(String widgetType, LogTable table) {
    table.put(".type", widgetType);
  }
}
