...
public class LoggedTracer {
  ...
  private static double subStartTime = -1.0;
  ...
  public static void startSubTracing() {
    subStartTime = Timer.getFPGATimestamp();
    // Logger.recordOutput("LoggedTracer/" + epochName + "MS", (now -
    // startTime) * 1000.0);
    // startTime = now;
  }

  public static void logSubTracing(String epochName) {
    double now = Timer.getFPGATimestamp();
    Logger.recordOutput("LoggedTracer/" + epochName + "MS", (now - subStartTime) * 1000.0);
  }
}
