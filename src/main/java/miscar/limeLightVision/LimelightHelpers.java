...
/**
 * LimelightHelpers provides static methods and classes for
 * interfacing with Limelight vision cameras in FRC. This library
 * supports all Limelight features including AprilTag tracking, Neural
 * Networks, and standard color/retroreflective tracking.
 */
public class LimelightHelpers {

  /**
   * Represents a Color/Retroreflective Target Result extracted from
   * JSON Output
   */
  ...
  /**
   * Represents an AprilTag/Fiducial Target Result extracted from JSON
   * Output
   */
  ...
  /**
   * Represents a Neural Classifier Pipeline Result extracted from JSON
   * Output
   */
  ...
  /**
   * Represents a Neural Detector Pipeline Result extracted from JSON
   * Output
   */
  ...
  /**
   * Limelight Results object, parsed from a Limelight's JSON results
   * output.
   */
  ...
  /**
   * Represents a Limelight Raw Fiducial result from Limelight's
  ...
  public static class PoseEstimate {
    ...
    public boolean equals(Object obj) {
      ...
      // We don't compare the timestampSeconds as it isn't relevant for
      // equality and makes
      // unit testing harder
  ...
  /**
   * Takes a 6-length array of pose data and converts it to a Pose3d
   * object. Array format: [x, y, z, roll, pitch, yaw] where angles are
   * in degrees.
   *
   * @param inData Array containing pose data [x, y, z, roll, pitch,
   *        yaw]
   * @return Pose3d object representing the pose, or empty Pose3d if
   *         invalid data
   */
  ...
  /**
   * Takes a 6-length array of pose data and converts it to a Pose2d
   * object. Uses only x, y, and yaw components, ignoring z, roll, and
   * pitch. Array format: [x, y, z, roll, pitch, yaw] where angles are
   * in degrees.
   *
   * @param inData Array containing pose data [x, y, z, roll, pitch,
   *        yaw]
   * @return Pose2d object representing the pose, or empty Pose2d if
   *         invalid data
   */
  ...
  /**
   * Converts a Pose3d object to an array of doubles in the format [x,
   * y, z, roll, pitch, yaw]. Translation components are in meters,
   * rotation components are in degrees.
   *
  ...
  /**
   * Converts a Pose2d object to an array of doubles in the format [x,
   * y, z, roll, pitch, yaw]. Translation components are in meters,
   * rotation components are in degrees. Note: z, roll, and pitch will
   * be 0 since Pose2d only contains x, y, and yaw.
   *
   ...
   *
   * @param limelightName Name/identifier of the Limelight
   * @return Array of doubles containing corner coordinates [x0, y0, x1,
   *         y1, ...]
   */
  ...
  /**
   * Prints detailed information about a PoseEstimate to standard
   * output. Includes timestamp, latency, tag count, tag span, average
   * tag distance, average tag area, and detailed information about each
   * detected fiducial.
   *
  ...
  /**
   * Gets the horizontal offset from the crosshair to the target in
   * degrees.
   *
   * @param limelightName Name of the Limelight camera ("" for default)
  ...
  /**
   * Gets the vertical offset from the crosshair to the target in
   * degrees.
   *
   * @param limelightName Name of the Limelight camera ("" for default)
  ...
  /**
   * Gets the horizontal offset from the principal pixel/point to the
   * target in degrees. This is the most accurate 2d metric if you are
   * using a calibrated camera and you don't need adjustable crosshair
   * functionality.
   *
   * @param limelightName Name of the Limelight camera ("" for default)
   * @return Horizontal offset angle in degrees
  ...
  /**
   * Gets the vertical offset from the principal pixel/point to the
   * target in degrees. This is the most accurate 2d metric if you are
   * using a calibrated camera and you don't need adjustable crosshair
   * functionality.
   *
  ...
  /**
   * Gets the detector class index from the primary result of the
   * currently running neural detector pipeline.
   *
   * @param limelightName Name of the Limelight camera
  ...
  /**
   * Gets the average color under the crosshair region as a 3-element
   * array.
   *
   * @param limelightName Name of the Limelight camera
   * @return Array containing [Blue, Green, Red] color values (BGR
   *         order)
   */
  ...
  /**
   * Gets the Limelight heartbeat value. Increments once per frame,
   * allowing you to detect if the Limelight is connected and alive.
   *
   * @param limelightName Name of the Limelight camera
  ...
  /**
   * (Not Recommended) Gets the robot's 3D pose in the WPILib Red
   * Alliance Coordinate System.
   *
   * @param limelightName Name/identifier of the Limelight
   * @return Pose3d object representing the robot's position and
   *         orientation in Red Alliance field space
   */
   ...
   * @param limelightName Name/identifier of the Limelight
   * @return Pose3d object representing the robot's position and
   *         orientation in Blue Alliance field space
   */
  ...
  /**
   * Gets the robot's 3D pose with respect to the currently tracked
  ...
  /**
   * Gets the camera's 3D pose with respect to the currently tracked
   * target's coordinate system.
   *
   * @param limelightName Name/identifier of the Limelight
   * @return Pose3d object representing the camera's position and
   *         orientation relative to the target
   */
  ...
  /**
   * Gets the target's 3D pose with respect to the camera's coordinate
   * system.
   *
   * @param limelightName Name/identifier of the Limelight
   * @return Pose3d object representing the target's position and
  ...
  /**
   * Gets the target's 3D pose with respect to the robot's coordinate
   * system.
   *
   * @param limelightName Name/identifier of the Limelight
   * @return Pose3d object representing the target's position and
  ...
  /**
   * Gets the camera's 3D pose with respect to the robot's coordinate
   * system.
   *
   * @param limelightName Name/identifier of the Limelight
   * @return Pose3d object representing the camera's position and
  ...
  /**
   * Gets the MegaTag1 Pose2d and timestamp for use with WPILib pose
   * estimator (addVisionMeasurement) in the WPILib Blue alliance
   * coordinate system.
   *
   * @param limelightName
   * @return
  ...
  /**
   * Gets the MegaTag2 Pose2d and timestamp for use with WPILib pose
   * estimator (addVisionMeasurement) in the WPILib Blue alliance
   * coordinate system. Make sure you are calling setRobotOrientation()
  ...
  /**
   * Gets the current IMU data from NetworkTables. IMU data is formatted
   * as [robotYaw, Roll, Pitch, Yaw, gyroX, gyroY, gyroZ, accelX,
   * accelY, accelZ]. Returns all zeros if data is invalid or
   * unavailable.
   *
   * @param limelightName Name/identifier of the Limelight
  ...
  /**
   * Enables Picture-in-Picture mode with secondary stream in the
   * corner.
   *
   * @param limelightName Name of the Limelight camera
   */
  ...
  /**
   * Sets the crop window for the camera. The crop window in the UI must
   * be completely open.
   *
   * @param limelightName Name of the Limelight camera
  ...
  /**
   * Sets robot orientation values used by MegaTag2 localization
   * algorithm.
   *
   * @param limelightName Name/identifier of the Limelight
   * @param yaw Robot yaw in degrees. 0 = robot facing red alliance wall
   *        in FRC
   * @param yawRate (Unnecessary) Angular velocity of robot yaw in
   *        degrees per second
   * @param pitch (Unnecessary) Robot pitch in degrees
   * @param pitchRate (Unnecessary) Angular velocity of robot pitch in
   *        degrees per second
   * @param roll (Unnecessary) Robot roll in degrees
   * @param rollRate (Unnecessary) Angular velocity of robot roll in
   *        degrees per second
   */
  public static void SetRobotOrientation(String limelightName, double yaw, double yawRate,
    ...
    SetRobotOrientation_INTERNAL(limelightName,
        yaw,
        yawRate,
        pitch,
        pitchRate,
  ...
  /**
   * Configures the complementary filter alpha value for IMU Assist
   * Modes (Modes 3 and 4)
   *
   * @param limelightName Name/identifier of the Limelight
   * @param alpha Defaults to .001. Higher values will cause the
   *        internal IMU to converge onto the assist source more
   *        rapidly.
   */
  ...
  /**
   * Configures the throttle value. Set to 100-200 while disabled to
   * reduce thermal output/temperature.
   *
   * @param limelightName Name/identifier of the Limelight
   * @param throttle Defaults to 0. Your Limelgiht will process one
   *        frame after skipping <throttle> frames.
   */
  ...
  /**
   * Overrides the valid AprilTag IDs that will be used for
   * localization. Tags not in this list will be ignored for robot pose
   * estimation.
   *
   * @param limelightName Name/identifier of the Limelight
  ...
  /**
   * Sets the downscaling factor for AprilTag detection. Increasing
   * downscale can improve performance at the cost of potentially
   * reduced detection range.
   *
   * @param limelightName Name/identifier of the Limelight
   * @param downscale Downscale factor. Valid values: 1.0 (no
   *        downscale), 1.5, 2.0, 3.0, 4.0. Set to 0 for pipeline
   *        control.
   */
  ...
  /**
   * Triggers a snapshot capture via NetworkTables by incrementing the
   * snapshot counter. Rate-limited to once per 10 frames on the
   * Limelight.
   *
   * @param limelightName Name of the Limelight camera
   */
  ...
  /**
   * Triggers a rewind capture with the specified duration. Maximum
   * duration is 165 seconds. Rate-limited on the Limelight.
   *
   * @param limelightName Name of the Limelight camera
   * @param durationSeconds Duration of rewind capture in seconds (max
   *        165)
   */
   ...
   *
   * <p>
   * For usbIndex 0: ports 5800-5809 forward to 172.29.0.1 For usbIndex
   * 1: ports 5810-5819 forward to 172.29.1.1 etc.
   *
   * <p>
  ...
  private static PoseEstimate getBotPoseEstimate(String limelightName, String entryName,
    ...
    // Convert server timestamp from microseconds to seconds and adjust
    // for latency
    ...
    if (poseArray.length != expectedTotalVals) {
      // Array size mismatch - return empty array instead of null-filled
      // array
